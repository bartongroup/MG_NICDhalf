...
@fig-dat shows all data, presented as log~2~ of normalised intensity, together with best-fitting straight lines fitted to time points 0 - 4h (see below for explanation).
...
@tbl-half shows the half life time for each condition, derived from the linear fits, together with propagated standard errors.
